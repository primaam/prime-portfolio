                        ...
                        <OwlCarousel className='owl-carousel' id="testimonial-carousel" {...options}>
                            ...
                            <div className="col-lg-12">
                                <div className='testi-item'>
                                    ...
                                    <div className="client-info">
                                        <img src={require("../../assets/Testimonial/lady.png")} alt="no internet connection"></img>
                                        <h5>Daisy Dominic</h5>
                                        <p>CEO WorkGlobal</p>
                                    </div>
                                </div>
                            ...
                            <div className="col-lg-12">
                                <div className='testi-item'>
                                    ...
                                    <div className="client-info">
                                        <img src={require("../../assets/Testimonial/man.png")} alt="no internet connection"></img>
                                        <h5>Michael</h5>
                                        <p>CEO Passionate</p>
                                    </div>
                                </div>
                            ...
                            <div className="col-lg-12">
                                <div className='testi-item'>
                                    ...
                                    <div className="client-info">
                                        <img src={require("../../assets/Testimonial/mike.png")} alt="no internet connection"></img>
                                        <h5>Mike Brown</h5>
                                        <p>CEO MikeGlobal</p>
                                    </div>
                                </div>
